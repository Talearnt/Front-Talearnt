...
function WriteArticle() {
  ...
  }, [accessToken, isError, isLoggedIn, navigator, setPrompt]);
        ...
        {isMatchType && isLoading ? (
          ...
          <>
            ...
            <TextEditor
              ...
              onImageHandler={imageFileList =>
                (isMatchType
                  ...
                  : handleCommunityDataChange)("imageFileList", imageFileList)
              }
              editorKey={type}
              error={
                isMatchType
            ...
            >
              ...
              <Button
                onClick={handleMatchSubmit(postMatchArticle)}
                disabled={isPostInProgress}
              >

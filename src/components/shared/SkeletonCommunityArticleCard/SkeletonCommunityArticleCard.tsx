...
function SkeletonCommunityArticleCard() {
  return (
    <div
    ...
    >
      ...
      <div className="mb-2 h-6 w-[70px] rounded-sm bg-talearnt_Icon_04" />
      <div className="mb-2 h-[58px] w-full rounded-sm bg-talearnt_Icon_04" />
      <div className="mb-10 h-5 w-[200px] rounded-sm bg-talearnt_Icon_04" />
...
export { SkeletonCommunityArticleCard };

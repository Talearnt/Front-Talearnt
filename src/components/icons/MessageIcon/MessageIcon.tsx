...
type MessageIconProps = CommonIconProps & {
  circleColor?: string;
};
...
function MessageIcon({
  className,
  size = 24,
  circleColor = "fill-talearnt_Icon_03",
  ...props
}: MessageIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <circle cx="7" cy="12" r="1" className={circleColor} />
      <circle cx="12" cy="12" r="1" className={circleColor} />
      <circle cx="17" cy="12" r="1" className={circleColor} />
    </svg>
  );
}

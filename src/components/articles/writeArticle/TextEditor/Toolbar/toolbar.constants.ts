export type attributorsType = {
  whitelist: string[];
};
export type quillIconsType = {
  bold: string | null;
  italic: string | null;
...
export const alignOptions = ["", "center", "right"] as const;
...
export const updatePickerItemColors = (selector: string) => {
